  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-green text-black hover:bg-green hover:text-slate-50 focus:bg-green focus:text-black dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
          "bg-blue text-slate-900 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
